...
bool UserPortBreakoutDialog::WM_INITDIALOG()
{
...
//	case WM_COMMAND:
bool UserPortBreakoutDialog::WM_COMMAND(WPARAM wParam)
{
		bool bit;
...
void UserPortBreakoutDialog::WM_CLEAR_KEY_MAPPING()
{
	BitKeys[m_BitKey] = 0;
...
bool UserPortBreakoutDialog::WM_SELECT_KEY_DIALOG_CLOSED(WPARAM wParam)
{
#ifndef __APPLE__
		if (wParam == IDOK)
		{
