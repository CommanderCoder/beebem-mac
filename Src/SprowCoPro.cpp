...
#else
	UEFWrite32((unsigned int)m_State->NumScycles, SUEF);
	UEFWrite32((unsigned int)m_State->NumNcycles, SUEF);
	UEFWrite32((unsigned int)m_State->NumIcycles, SUEF);
	UEFWrite32((unsigned int)m_State->NumCcycles, SUEF);
	UEFWrite32((unsigned int)m_State->NumFcycles, SUEF);
#endif
...
#else
	UEFWrite32((unsigned int)m_State->LastTime, SUEF);
#endif
	UEFWrite32(m_State->CP14R0_CCD, SUEF);
#ifndef __APPLE__
	UEFWrite32(m_State->Now, SUEF);
#else
	UEFWrite32((unsigned int)m_State->Now, SUEF);
#endif
